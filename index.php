...
<body data-rsssl="1" class="home page-template page-template-full-width page-template-full-width-php page page-id-3909 eltd-core-1.1.2 eltdf-restaurant-1.0 non-logged-in gourmand-ver-1.3 eltdf-smooth-page-transitions eltdf-grid-1100 eltdf-empty-google-api eltdf-light-header eltdf-fixed-on-scroll eltdf-dropdown-animate-height eltdf-header-standard eltdf-menu-area-shadow-disable eltdf-menu-area-in-grid-shadow-disable eltdf-menu-area-border-disable eltdf-menu-area-in-grid-border-disable eltdf-logo-area-border-disable eltdf-header-vertical-shadow-disable eltdf-header-vertical-border-disable eltdf-side-menu-slide-from-right eltdf-default-mobile-header eltdf-sticky-up-mobile-header eltdf-top-bar-in-grid-padding wpb-js-composer js-comp-ver-6.0.3 vc_responsive" itemscope="" itemtype="http://schema.org/WebPage">
				...
				<div class="eltdf-content-inner">
					<div class="eltdf-slider">
						<div class="eltdf-slider-inner">
							<link href="css-1?family=Raleway:900%2C400%7CAlex+Brush:400%7COpen+Sans:400" rel="stylesheet" property="stylesheet" type="text/css" media="all">
										...
										function onLoad() {
											...
											if (tpj("#rev_slider_1_1").revolution == undefined) {
												...
												revapi1 = tpj("#rev_slider_1_1").show().revolution({
													sliderType: "standard",
													jsFileLocation: "//lotipoints.com/wp-content/plugins/revslider/public/assets/js/",
													sliderLayout: "fullscreen",
													dottedOverlay: "none",
													delay: 4000,
													navigation: {
										...
										<div class="wpb_column vc_column_container vc_col-sm-8">
											<div class="vc_column-inner">
												<div class="wpb_wrapper">
													...
													<div class="vc_empty_space" style="height: 60px"><span class="vc_empty_space_inner"></span></div>
													<div class="eltdf-image-gallery  eltdf-ig-grid-type eltdf-normal-space eltdf-has-shadow eltdf-image-behavior-lightbox">
											...
											<div class="vc_column-inner">
												<div class="wpb_wrapper">
													...
													<div class="wpb_single_image wpb_content_element vc_align_center  wpb_animate_when_almost_visible wpb_fadeIn fadeIn">
														...
														<figure class="wpb_wrapper vc_figure">
															<div class="vc_single_image-wrapper   vc_box_border_grey">
																<img width="873" height="348" src="wp-content/uploads/2020/11/map2.png" class="vc_single_image-img attachment-full" alt="" decoding="async" loading="lazy" srcset="wp-content/uploads/2020/11/map2.png 873w, wp-content/uploads/2020/11/map2-300x120.png 300w, wp-content/uploads/2020/11/map2-768x306.png 768w" sizes="(max-width: 873px) 100vw, 873px">
															</div>
														</figure>
													</div>
...
<!-- Page generated by LiteSpeed Cache 2.9.7 on 2023-08-26 19:03:02 -->